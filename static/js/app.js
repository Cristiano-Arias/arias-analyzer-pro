    ...
    container.innerHTML = `
        <div class="card">
            ...
            <form id="trForm">
                ...
                <!-- A ordem de exibição foi ajustada para refletir as novas regras.  Primeiro a matriz de responsabilidades,
                     seguida pelos requisitos de SST, pelo campo de credenciamento, depois as normas a observar e por fim
                     o campo de observações gerais. -->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea id="trCredenciamento" rows="2" placeholder="Requisitos de credenciamento..."></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="trObservacoes" rows="2" placeholder="Observações gerais..."></textarea>
                </div>
            </form>
        </div>
    `;
...
async function loadTRData(tr) {
    ...
    // Campos adicionais (Credenciamento e Observações) – podem não existir em TRs antigos
    if (document.getElementById('trCredenciamento')) {
        document.getElementById('trCredenciamento').value = tr.credenciamento || tr.credenciamento_observacoes || '';
    }
    if (document.getElementById('trObservacoes')) {
        document.getElementById('trObservacoes').value = tr.observacoes || '';
    }
...
async function saveTR() {
    ...
    const trData = {
        ...
        // Recolhe os campos adicionais conforme a nova ordem.  A norma foi movida para o penúltimo campo,
        // enquanto credenciamento e observações foram adicionados.
        matriz_responsabilidades: document.getElementById('trMatriz').value,
        sst: document.getElementById('trSST').value,
        credenciamento: document.getElementById('trCredenciamento') ? document.getElementById('trCredenciamento').value : '',
        normas_observar: document.getElementById('trNormas').value,
        observacoes: document.getElementById('trObservacoes') ? document.getElementById('trObservacoes').value : '',
